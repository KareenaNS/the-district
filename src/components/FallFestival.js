...
const flyerImage = "/fall_flyer.png";

function FallFestival() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const images = [
    process.env.PUBLIC_URL + "/fall/1.JPG",
    process.env.PUBLIC_URL + "/fall/2.JPG",
    process.env.PUBLIC_URL + "/fall/3.JPG",
    process.env.PUBLIC_URL + "/fall/4.JPG",
    process.env.PUBLIC_URL + "/fall/5.JPG",
    process.env.PUBLIC_URL + "/fall/6.JPG",
    process.env.PUBLIC_URL + "/fall/7.JPG",
    process.env.PUBLIC_URL + "/fall/8.JPG",
    process.env.PUBLIC_URL + "/fall/9.JPG",
    process.env.PUBLIC_URL + "/fall/10.JPG",
    process.env.PUBLIC_URL + "/fall/11.JPG",
    process.env.PUBLIC_URL + "/fall/12.JPG",
    process.env.PUBLIC_URL + "/fall/13.JPG",
    process.env.PUBLIC_URL + "/fall/14.JPG",
    process.env.PUBLIC_URL + "/fall/15.JPG",
    process.env.PUBLIC_URL + "/fall/16.JPG",
    process.env.PUBLIC_URL + "/fall/17.JPG",
    process.env.PUBLIC_URL + "/fall/18.JPG",
    ];
  const nextImage = () => {
  ...
  return (
    <div className="lacont">
      ...
      <h1>Fall Fest</h1>
      <section className="event-deets-fall">
        <h2>Event Details</h2>
        ...
        <p>
          <strong>Join us for Fall Fest! </strong> 
          Celebrate the magic of the season at Fall Fest! Enjoy a day filled with autumn vibes—pumpkin decorating, hayrides, local vendors, games, live music, and delicious seasonal treats. Perfect for families and friends, it’s a cozy community event you won’t want to miss!
</p>
      ...
      <section className="vendor-sponsor-contain">
        <section className="volunteerfall">
        ...
        <section className="vendorfall">
          ...
          />
          <p>
            If you're interested in becoming a vendor for Fall Fest,
          ...
          <h2>Vendor Payment Links</h2>
            <p>Interested in paying for a slot at Fall Fest? Click the button below!</p>
            <a
              href="https://morrowga.gov/tc-events/fall-festival"
              target="_blank"
              rel="noopener noreferrer"
              className="cta-button"
            >
        ...
        <section className="sponsorfall">
          ...
          />
          <p>
            Support Fall Fest by becoming a sponsor! Gain exposure for
      ...
      <section className="gall-container">
        <div className="gall">
        <img src="/fall/1.JPG" alt="Event 1" />
        <img src="/fall/2.JPG" alt="Event 2" />
        <img src="/fall/3.JPG" alt="Event 3" />
        <img src="/fall/4.JPG" alt="Event 4" />
        <img src="/fall/5.JPG" alt="Event 5" />
        <img src="/fall/6.JPG" alt="Event 6" />
        <img src="/fall/7.JPG" alt="Event 7" />
        <img src="/fall/8.JPG" alt="Event 8" />
        <img src="/fall/9.JPG" alt="Event 9" />
        <img src="/fall/10.JPG" alt="Event 10" />
        <img src="/fall/11.JPG" alt="Event 11" />
        <img src="/fall/12.JPG" alt="Event 12" />
        <img src="/fall/13.JPG" alt="Event 13" />
        <img src="/fall/14.JPG" alt="Event 14" />
        <img src="/fall/15.JPG" alt="Event 15" />
        <img src="/fall/16.JPG" alt="Event 16" />
        <img src="/fall/17.JPG" alt="Event 17" />
        <img src="/fall/18.JPG" alt="Event 18" />
        </div>
      </section>
