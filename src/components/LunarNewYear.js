...
const flyerImage = '/lunarNewYear.jpg';
...
function LunarNewYear() {
  ...
  <section className="vendor-info">
    ...
    <p>If you're interested in becoming a vendor for Lunar New Year, here's how you can get involved:</p>
    <ul>
  ...
  <section className="sponsor-info">
    ...
    <p>Support Lunar New Year by becoming a sponsor! Gain exposure for your business while helping to celebrate and uplift African American culture.</p>
    <ul>
    ...
    <iframe
        src={process.env.PUBLIC_URL + '/lny-sponsor.pdf'}
        width="100%"
        height="600px"
