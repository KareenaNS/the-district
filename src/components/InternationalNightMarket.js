...
function InternationalNightMarket() {
  ...
  return (
    <div className="landage-container">
      ...
      <h1>
        <img src="title.png" alt="Header Image"></img>
      </h1>
...
Join us for the International Night Market, a dynamic celebration of global cultures featuring delicious food, captivating performances, and unique traditions from around the world. Enjoy an unforgettable evening of flavor, music, and dance as we come together to honor the rich diversity that makes our community thrive.
        ...
        <div className="detsection">
          ...
          <div>
            <h3>DATE</h3>
            <p>
              <span>October 4th + 5th, 2025</span>
            </p>
          </div>
        </div>
        ...
        <div className="detsection">
          <div>
            <h3>TIME</h3>
            <p>
              <span>Saturday: 2 - 11:30 PM</span>
            </p>
                        <p>
              <span>Sunday: 2 - 11:30 PM</span>
            </p>
          </div>
  ...
  <div className="responsive-panel-container">
    <div className="responsive-panel">
      ...
      <img
        src={process.env.PUBLIC_URL + "/cosplay.jpeg"}
        alt="Cosplay"
        className="j-image"
      />
      <p>
        Ready to enter our COSPLAY CONTEST? Read the requirements below and reach out to events@morrowga.gov or Elizabeth (470-773-2708) for more information!
      </p>
      <ul>
        Register at the stage by 5 PM on Sunday. October 4th.
      </ul>
      <ul>
        Top 5 costumes will be awarded on stage.
      </ul>
      <ul>
        Cash prize is $600 USD, and there is an additional gift. 
      </ul>
      <ul>
        Main sponsor of this contest is Pelican Hill Medical Center. 
      </ul>
      <ul>
        For more information, reach out to (470)-487-0241 or (470)-921-2206!
      </ul>
    ...
    <div className="responsive-panel">
      <h1>Lantern Contest</h1>
      <img
        src={process.env.PUBLIC_URL + "/lantern.jpeg"}
        alt="Lantern"
        className="j-image"
      />
      <p>
        Ready to enter our LANTERN MAKING CONTEST? Read the requirements below and reach out to events@morrowga.gov or Elizabeth (470-773-2708) for more information!
      </p>
      <ul>
        Each participant is allowed a maximum of one (1) lantern.
      </ul>
      <ul>
        Lanterns must be BATTERY-POWERED only.
      </ul>
      <ul>
        Lanterns must be unique with no trademarked logos. (No previous submissions!) 
      </ul>
      <ul>
        Name, age, and contact number must be labeled on the lantern. 
      </ul>
      <ul>
        Text your submission to (404)-784-5814 by SEPTEMBER 21st, 2025!
      </ul>
    </div>
  </div>
</section>
      ...
      <section className="vendor-sponsor-contain">
        ...
        <section className="vendor-infos">
          ...
          />
          <p>
            If you're interested in becoming a vendor for International Night Market / Moon Festival,
