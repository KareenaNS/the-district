...
function MexicanIndependenceDay() {
  ...
  return (
    <div className="ladcontainr">
      ...
      <h1>Mexican Independence Day</h1>
      <section className="event-detalle">
        <h2>Event Details</h2>

        <img
          src={process.env.PUBLIC_URL + flyerImage}
          alt="Mexican Independence Day"
          className="flyer-image"
        />

        <p>
          <strong>Join us for Mexican Independence Day! </strong> 
          Celebrate culture, music, and heritage! Our Mexican Independence Day event draws families and festival-goers for a vibrant day of performances, food, and tradition        </p>
      ...
      <section className="vendor-sponsor-contain">
        ...
        <section className="vendormid">
          ...
          />
          <p>
            If you're interested in becoming a vendor for Mexican Independence Day,
          ...
          <h2>Vendor Payment Links</h2>
            <p>Interested in paying for a slot at Mexican Independence Day? Click the button below!</p>
            <a
              href="https://morrowga.gov/tc-events/mexican-independence-day/"
              target="_blank"
              rel="noopener noreferrer"
              className="cta-button"
            >
          ...
          <iframe
            src="https://forms.office.com/Pages/ResponsePage.aspx?id=Id1HTAYKMEeF20yDdtNCINTtYiHrpEpAhDG5XILqbJNUNVkyUUlNWDk5UkhQSkNLVU1NTEQ1RExRUS4u"
            width="100%"
            height="600px"
            frameborder="0"
            allowfullscreen
        ...
        <section className="sponsormid">
          ...
          />
          <p>
            Support Mexican Independence Day by becoming a sponsor! Gain exposure for
...
export default MexicanIndependenceDay;
